...
function HeroMockCard() {
  ...
  return (
    <div ref={ref} className="lp-reveal mt-16 max-w-4xl mx-auto" style={{ transitionDelay: "0.1s" }}>
      <div
        className="rounded-2xl overflow-hidden lp-float relative"
        style={{
          background: "#fff",
      ...
      >
        ...
        >
          ...
          <div
            className="ml-3 px-2.5 py-0.5 rounded text-[10px] font-medium"
        ...
        <div className="p-6 sm:p-8 text-left">
          ...
          <div className="space-y-3">
            {[
              ...
              <div
                key={s.label}
                className="rounded-lg p-3 lp-reveal"
                style={{
                  background: "#fafbff",
